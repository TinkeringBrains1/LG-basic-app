                        ...
                        children: [
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(backgroundColor: ThemeColors.secondaryColor,shape: const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(50)))),
                              child: FittedBox(
                                child: Row(
                                children: [
